...
public class CourseController {
  ...
  public DataResponse updateCourse(@RequestBody Map<String, Course> body) {
    ...
    if (repoCourse.isEmpty()) return new DataResponse(null, "此課程不存在");
  ...
  public DataResponse getCourseList() {
    ...
    List<Map<String, Object>> resultList = courseList.stream()
      .map(course -> {
  ...
  public DataResponse deleteCourseById(@RequestBody Map<String, Course> body) {
    ...
    if (repoCourse.isEmpty()) return new DataResponse(null, "無此課程");
